...
class MalfuctionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('malfunctions')->insert([
            ...
            ['product_id' => '2','name' => 'Perde acqua','description'=>'Il dispositivo perde acqua','created_at' => date("Y-m-d H:i:s"),'updated_at' => date("Y-m-d H:i:s")],
            ['product_id' => '3','name' => 'Danneggiamento generico','description'=>'Il dispositivo peesenta evidenti danneggiamenti','created_at' => date("Y-m-d H:i:s"),'updated_at' => date("Y-m-d H:i:s")],
        ...
        DB::table('solutions')->insert([
            ...
            ['malfunction_id' => '2','name' => 'Fusibili','description'=>'Controllare la presenza di fusibili fusi','created_at' => date("Y-m-d H:i:s"),'updated_at' => date("Y-m-d H:i:s")],
            ['malfunction_id' => '3','name' => 'Serraggio giunzioni','description'=>'Controllare il serraggio delle giunzioni','created_at' => date("Y-m-d H:i:s"),'updated_at' => date("Y-m-d H:i:s")],
